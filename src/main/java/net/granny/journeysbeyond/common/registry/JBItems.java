...
public class JBItems {
    ...
    public static final RegistryObject<Item> ACTIVE_RUBY = ITEMS.register("active_ruby", () -> new ActiveNetherRuby(new Item.Properties().stacksTo(1).rarity(Rarity.COMMON).durability(192)));
