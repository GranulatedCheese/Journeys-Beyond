...
public class JBDamageSources {
    ...
    public static JBDamageSources instance(Level level) {
    ...
    public DamageSource healthStealAttack(LivingEntity pPlayer) {
        return this.source(JBDamageTypes.HEALTH_STEAL_ATTACK, pPlayer);
    }
}
